                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="mb-4">
                                <label for="rental_price_per_day"
                                    class="block text-sm font-medium text-gray-700 dark:text-gray-300">Rental Price Per
                                    Day</label>
                                <input type="number" name="rental_price_per_day" id="rental_price_per_day"
                            ...
                            <div class="mb-4 md:col-span-2">
                                ...
                                <textarea rows="5" name="description" id="description"
                                    class="mt-1 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md dark:bg-gray-700 dark:border-gray-600 dark:text-gray-300">{{ old('description') }}</textarea>
                                @error('description')
                                    <p class="text-sm text-red-600 dark:text-red-400 mt-2">{{ $message }}</p>
                                @enderror
                            </div>
